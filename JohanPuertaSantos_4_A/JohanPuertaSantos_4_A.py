# This program takes a user's e-mail as input and scans every word in each line for
# the presence of spam words. The spam words are stored in a file called spam_checker.txt.
